...
(2, 6, 'What’s the recipe? Looks tasty!', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
(3, 5, 'Love the colors in your painting!', NULL, CURRENT_TIMESTAMP, NULL, 'enable'),
(4, 8, 'Share the cafe name, please!', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
...
(1, 13, 'Just saw a rare bird on my last hike!', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
...
(1, 1, 'Sunrise hikes are the best!', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
...
INSERT INTO group_posts (group_id, user_id, content, image_path, created_at, updated_by, status) VALUES
(2, 5, 'Sharing my latest sketch. Feedback welcome!', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
(2, 8, 'New painting in progress.', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
...
(2, 8, 'Just finished a digital art piece.', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
...
INSERT INTO group_posts (group_id, user_id, content, image_path, created_at, updated_by, status) VALUES
(4, 2, 'Captured a sunset yesterday.', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
...
(4, 6, 'Sharing my latest street photography.', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
...
(4, 12, 'Sharing a time-lapse project.', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
...
INSERT INTO group_posts (group_id, user_id, content, image_path, created_at, updated_by, status) VALUES
(6, 11, 'Sourdough loaf turned out great!', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
...
(6, 14, 'Sharing my muffin recipe.', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
...
(6, 11, 'Sharing my brownie recipe.', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
...
(7, 4, 'Sharing my travel journal.', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
...
INSERT INTO group_posts (group_id, user_id, content, image_path, created_at, updated_by, status) VALUES
(8, 8, 'New song I’m working on.', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
...
(8, 13, 'Sharing my latest cover.', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
...
(8, 13, 'Sharing my playlist.', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
...
(9, 13, 'Sharing my GitHub project.', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
...
(10, 11, 'Just tried a new yoga flow.', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
...
INSERT INTO group_posts (group_id, user_id, content, image_path, created_at, updated_by, status) VALUES
(11, 10, 'New game I’m playing, love it!', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
...
(11, 5, 'Sharing my gaming setup.', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
...
(11, 10, 'Sharing my speedrun.', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
...
INSERT INTO group_posts (group_id, user_id, content, image_path, created_at, updated_by, status) VALUES
(12, 14, 'New monstera cutting!', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
...
(12, 14, 'Sharing my plant shelf.', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
...
(12, 14, 'Sharing my terrarium.', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
...
INSERT INTO group_posts (group_id, user_id, content, image_path, created_at, updated_by, status) VALUES
(14, 12, 'New Python project I’m working on.', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
...
(14, 10, 'Sharing my web app.', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
...
(14, 12, 'Sharing my CLI tool.', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
...
(15, 6, 'Just tried a new roast.', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
...
(2, 7, 'Great camping tips!', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
(17, 8, 'Love the shading in your sketch!', NULL, CURRENT_TIMESTAMP, NULL, 'enable'),
(18, 1, 'Awesome digital art!', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
...
(50, 12, 'Love the street photography!', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
...
(82, 14, 'Those muffins look delicious!', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
...
(130, 11, 'Cool app idea!', '/uploads/posts/default.jpg', CURRENT_TIMESTAMP, NULL, 'enable'),
...
-- Insert notifications (12 columns: user_id, type, follow_req_id, group_invite_id, group_id, event_id, content, is_read, created_at, updated_at, updated_by, status)
...
(1, 'follow_request', 1, NULL, NULL, NULL, 'Emma wants to follow you.', FALSE, CURRENT_TIMESTAMP, NULL, NULL, 'enable'),
(1, 'follow_request', 2, NULL, NULL, NULL, 'Emma wants to follow you.', FALSE, CURRENT_TIMESTAMP, NULL, NULL, 'enable'),
(1, 'follow_request', 3, NULL, NULL, NULL, 'Emma wants to follow you.', FALSE, CURRENT_TIMESTAMP, NULL, NULL, 'enable'),
(1, 'follow_request', 4, NULL, NULL, NULL, 'Emma wants to follow you.', FALSE, CURRENT_TIMESTAMP, NULL, NULL, 'enable'),
(1, 'follow_request', 5, NULL, NULL, NULL, 'Emma wants to follow you.', FALSE, CURRENT_TIMESTAMP, NULL, NULL, 'enable'),
(1, 'follow_request', 6, NULL, NULL, NULL, 'Aziz wants to follow you.', FALSE, CURRENT_TIMESTAMP, NULL, NULL, 'enable'),
(12, 'follow_request', 1, NULL, NULL, NULL, 'Amina wants to follow you.', FALSE, CURRENT_TIMESTAMP, NULL, NULL, 'enable'),
(6, 'follow_request', 9, NULL, NULL, NULL, 'Olivia wants to follow you.', FALSE, CURRENT_TIMESTAMP, NULL, NULL, 'enable'),
(6, 'group_invitation', NULL, 2, 1, NULL, 'You’ve been invited to Art Enthusiasts.', FALSE, CURRENT_TIMESTAMP, NULL, NULL, 'enable'),
(4, 'event_creation', NULL, NULL, 2, 3, 'New event: Book Discussion in Book Club.', FALSE, CURRENT_TIMESTAMP, NULL, NULL, 'enable'),
(8, 'group_join_request', NULL, NULL, 1, NULL, 'Mia wants to join Art Enthusiasts.', FALSE, CURRENT_TIMESTAMP, NULL, NULL, 'enable'),
(13, 'group_invitation', NULL, 4, 3, NULL, 'You’ve been invited to Photography Hub.', FALSE, CURRENT_TIMESTAMP, NULL, NULL, 'enable'),
(1, 'event_creation', NULL, NULL, 4, 2, 'New event: Group Run in Fitness Fanatics.', FALSE, CURRENT_TIMESTAMP, NULL, NULL, 'enable'),
(9, 'group_join_request', NULL, NULL, 5, NULL, 'Zara wants to join Travel Explorers.', FALSE, CURRENT_TIMESTAMP, NULL, NULL, 'enable'),
(11, 'event_creation', NULL, NULL, 6, 8, 'New event: Jam Session in Music Makers.', FALSE, CURRENT_TIMESTAMP, NULL, NULL, 'enable'),
(2, 'group_invitation', NULL, 9, 7, NULL, 'You’ve been invited to Tech Talk.', FALSE, CURRENT_TIMESTAMP, NULL, NULL, 'enable'),
(14, 'group_join_request', NULL, NULL, 8, NULL, 'Luca wants to join Yoga & Meditation.', FALSE, CURRENT_TIMESTAMP, NULL, NULL, 'enable'),
(7, 'event_creation', NULL, NULL, 9, 11, 'New event: Game Night in Gamers Guild.', FALSE, CURRENT_TIMESTAMP, NULL, NULL, 'enable'),
(4, 'group_invitation', NULL, 12, 10, NULL, 'You’ve been invited to Plant Parents.', FALSE, CURRENT_TIMESTAMP, NULL, NULL, 'enable'),
(8, 'event_creation', NULL, NULL, 11, 13, 'New event: History Trivia in History Buffs.', FALSE, CURRENT_TIMESTAMP, NULL, NULL, 'enable'),
(10, 'group_join_request', NULL, NULL, 12, NULL, 'Finn wants to join Code Crafters.', FALSE, CURRENT_TIMESTAMP, NULL, NULL, 'enable'),
(1, 'event_creation', NULL, NULL, 13, 15, 'New event: Coffee Tasting in Coffee Connoisseurs.', FALSE, CURRENT_TIMESTAMP, NULL, NULL, 'enable'),
(3, 'group_invitation', NULL, 6, 14, NULL, 'You’ve been invited to Baking Buddies.', FALSE, CURRENT_TIMESTAMP, NULL, NULL, 'enable'),
(5, 'group_join_request', NULL, NULL, 15, NULL, 'Amina wants to join Nature Lovers.', FALSE, CURRENT_TIMESTAMP, NULL, NULL, 'enable');
