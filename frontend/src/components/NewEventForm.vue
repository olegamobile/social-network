<template>
    <div
        ...
        <!-- submit button -->
        <button @click="createEvent" :disabled="!form.title.trim() || !form.description.trim() || !form.event_datetime.trim()" class="inline-flex items-center py-2 px-4 border border-[var(--nordic-border-light)] rounded-md 
